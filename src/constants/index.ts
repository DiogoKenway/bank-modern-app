...
const features = [
    {
        ...
        icon: star,
        title: "Rewards",
        content: "the best credit cards offer some tentalizing combinations of promotions and prizes"
    },
    {
        id: "feature-2",
        icon: shield,
...
const feedback = [
    {
        id: "feedback-1",
        content: "Money is only a tool. It will you wherever you wish, but it will not replace you as the driver.",
        name: "Herman Jensen",
    ...
    {
        id: "feedback-2",
        content: "Money makes your life easier. If you're luck to have it, you're lucky.",
        name: "Steve Mark",
        title: "Founder & Leader",
        img: people02
